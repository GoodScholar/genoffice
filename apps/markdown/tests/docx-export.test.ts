...
describe('protected source export', () => {
  it('exports protected block and inline source verbatim as monospace runs', async () => {
    const blockHtml = '<section data-note="raw">\n  <button>do not render</button>\n</section>'
